...
// https://jqueryvalidation.org/TarjetaCredito-method/
...
/* NOTICE: Modified version of Castle.Components.Validator.TarjetaCreditoValidator
 * Redistributed under the Apache License 2.0 at http://www.apache.org/licenses/LICENSE-2.0
 * Valid Types: mastercard, visa, amex, dinersclub, enroute, discover, jcb, unknown, all (overrides all other settings)
 */
$.validator.addMethod( "TarjetaCreditotypes", function( value, element, param ) {
	if ( /[^0-9\-]+/.test( value ) ) {
		return false;
	}
